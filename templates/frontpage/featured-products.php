<section class="block">
    ...
    <div class="content featured-products slideshow-products--wrapper">
        <?php if ( $shortcode = get_field( 'featured_products_shortcode' ) ) { echo do_shortcode( $shortcode ); } ?>
    </div>
</section>