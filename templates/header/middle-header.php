<header class="block">
                    ...
                    <div class="woocommerce-search--wrapper">
                        <div class="widget woocommerce widget_product_search">
                            ...
                            <form role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                <label class="screen-reader-text" for="woocommerce-product-search-field-<?php echo esc_attr( $index ); ?>"><?php esc_html_e( 'Buscar por:', 'woocommerce' ); ?></label>
                                ...
                                <button type="submit" value="Buscar" class="search-button">
    ...
    <div id="customer-service-phone">
        <p><?php esc_html_e('Servicio al cliente', 'stroyka'); ?></p>
        <?php
            $phone = get_theme_mod('phone_number', '2299216844');
            $formatted_phone = format_phone_number($phone);
        ?>
        <a class="customer-service" href="tel:<?php echo esc_attr($phone); ?>">
