document.addEventListener('DOMContentLoaded', function () {
    setTimeout(() => {
        ...
        slideshow.addEventListener('touchend', () => {
            ...
            if (Math.abs(deltaX) > 50) { // Umbral para evitar toques accidentales
                if (deltaX < 0) {
                    prev(); // Swipe a la izquierda: siguiente slide
                } else {
                    next(); // Swipe a la derecha: slide anterior
                }
            }
            startX = 0;
            endX = 0;
        ...
        console.log('slideshow FP with swipe support ready');
    }, 1000);
});