<section class="block">
    <div class="content block_header block_header__slideshow">
        ...
        <div class="block_header__buttons">
            <button class="slideshow__button backward-button-s" data-direction="prev" aria-label="Retroceder">
                <svg width="7px" height="11px">
                    <use xlink:href="<?php echo get_template_directory_uri(); ?>/assets/img/sprite.svg#arrow-rounded-left-7x11"></use>
                </svg>
            </button>
            <button class="slideshow__button forward-button-s" data-direction="next" aria-label="Avanzar">
                <svg width="7px" height="11px">
    ...
    <div class="content sales slideshow-products--wrapper">
        <?php if ( $shortcode = get_field( 'sales_shortcode' ) ) { echo do_shortcode( $shortcode ); } ?>
    </div>
</section>