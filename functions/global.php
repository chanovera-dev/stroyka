    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            #mobile-header .header-content .site-brand{margin-left:10px;}
            ...
            #mobile-header .searchform-wrapper{position:absolute;top:-100%;left:0;width:100%;height:100%;border-radius:0;background-color:var(--wp--preset--color--background);box-shadow:0 1px 7px rgb(0 0 0 / 25%);z-index:4;}
            ...
            .menu-mobile--wrapper.open{left:0;box-shadow:0 10px 21px rgba(0 0 0 / 25%);}
                ...
                #menu-mobile ul li a{padding:0 20px;display:flex;align-items:center;height:48px;color:var(--wp--preset--color--text);border-bottom:1px solid var(--wp--preset--color--border);border-radius:0;}
                /* submenús */
                #menu-mobile > ul li.menu-item-has-children{position:relative;}
                    /* botón */
                    #menu-mobile > ul li.menu-item-has-children .mobile-links__item-toggle{position:absolute;top:0;right:0;width:48px;height:48px;background-color:var(--wp--preset--color--background);border:none;border-left:1px solid var(--wp--preset--color--border);border-bottom:1px solid var(--wp--preset--color--border);border-radius:0;}
